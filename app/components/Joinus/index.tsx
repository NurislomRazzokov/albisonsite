...
const Join = () => {
  return (
    <div className="bg-joinus my-32 overflow-hidden">
      <div className="mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-lightblack text-base font-normal">
            Dasturlashni o'rganib yuqori daromadli kasbga ega bo'lmoqchisiz 😎 <br /> Lekin uyqusiz tunlar va tinimsiz mehnatga tayyormisiz? 🤔
          </p>
        </div>
